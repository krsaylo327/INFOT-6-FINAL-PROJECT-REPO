...
@section('page_title', 'My Travel Orders')
...
<div class="max-w-5xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">Personal travel order requests you have submitted</p>
        </div>
    ...
    @if($travelOrders->isEmpty())
        <div class="bg-white rounded-2xl border border-slate-200 p-12 text-center">
            ...
            <p class="text-xs text-slate-400 mt-1">Submit a request for a personal travel order to get started</p>
            <a href="{{ route('travel-orders.personal.create') }}"
            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-slate-100 text-left">
                        ...
                        <th class="px-4 py-3 font-semibold text-slate-500 text-xs uppercase tracking-wide">Noted By</th>
