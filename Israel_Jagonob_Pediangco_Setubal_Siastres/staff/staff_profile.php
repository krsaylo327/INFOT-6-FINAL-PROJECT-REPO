...
<head>
    ...
    <title>Staff Profile - HIMAKAS</title>
...
<div class="staff-main">
    ...
    <div class="profile-summary profile-center">
        ...
        <div style="margin-top:8px; font-size:14px; color:#667eea;">Click avatar or edit button to choose a photo</div>
    ...
    <form method="POST" action="staff_profile.php" class="profile-form" enctype="multipart/form-data">
    ...
    <script>
        ...
        if (staffPhotoInput && profileForm) {
